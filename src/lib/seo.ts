...
export function getSoftwareApplicationJsonLd() {
  return {
    ...
    offers: {
      ...
      description: "Plans from ₹2,999/mo with included voice minutes. Contact us for Enterprise.",
    },
    publisher: { "@id": organizationId },
    author: { "@id": founderId },
  };
  ...
  return {
    ...
    offers: {
      ...
      priceSpecification: {
        ...
        priceCurrency: "USD",
        price: "399",
        description: "Starter plan from ₹2,999/mo with 600 included voice minutes.",
      },
    },
  };
}
