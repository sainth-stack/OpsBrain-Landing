...
export const multilingualSection = {
  ...
  subtitle: "Hear natural AI voice samples across Sales, Support, HR, and more — in Telugu, Hindi, and English.",
  nativeEngineBadge: "Sample Voices",
} as const;

export const voiceDemoCategories = [
  {
    id: "sales",
    label: "Sales",
    description: "Qualifies leads and books demos in under 60 seconds",
  },
  {
    id: "support",
    label: "Customer Support",
    description: "Resolves CRM and product questions 24/7",
  },
  {
    id: "hr",
    label: "HR Recruiting",
    description: "Screens candidates and schedules interviews automatically",
  },
  {
    id: "realestate",
    label: "Real Estate",
    description: "Qualifies buyers and books property viewings instantly",
  },
  {
    id: "healthcare",
    label: "Healthcare",
    description: "Books appointments and verifies insurance 24/7",
  },
] as const;

export type VoiceDemoCategoryId =
  (typeof voiceDemoCategories)[number]["id"];

export const voiceDemos = [
  {
    id: "sales-en",
    categoryId: "sales" as VoiceDemoCategoryId,
    language: "English",
    languageNative: "English",
    scriptBadge: "EN",
    persona: "Sarah",
    trait: "Confident & Clear",
    audioSrc: "/audio/sales-en.mp3",
    fallbackLang: "en-US",
    fallbackDuration: 38,
  },
  {
  ...
  },
  {
    ...
    audioSrc: "/audio/sales-te.mp3",
    fallbackLang: "te-IN",
    fallbackDuration: 42,
  },
  {
    id: "support-en",
    categoryId: "support" as VoiceDemoCategoryId,
    language: "English",
    languageNative: "English",
    scriptBadge: "EN",
    persona: "Maya",
    trait: "Calm & Helpful",
    audioSrc: "/audio/support-en.mp3",
    fallbackLang: "en-US",
    fallbackDuration: 36,
  },
  {
  ...
  },
  {
    ...
    audioSrc: "/audio/support-te.mp3",
    fallbackLang: "te-IN",
    fallbackDuration: 40,
  },
  {
    id: "hr-en",
    categoryId: "hr" as VoiceDemoCategoryId,
    language: "English",
    languageNative: "English",
    scriptBadge: "EN",
    persona: "Emily",
    trait: "Warm & Professional",
    audioSrc: "/audio/hr-en.mp3",
    fallbackLang: "en-US",
    fallbackDuration: 36,
  },
  {
  ...
  },
  {
    ...
    audioSrc: "/audio/hr-te.mp3",
    fallbackLang: "te-IN",
    fallbackDuration: 40,
  },
  {
    id: "realestate-en",
    categoryId: "realestate" as VoiceDemoCategoryId,
    language: "English",
    languageNative: "English",
    scriptBadge: "EN",
    persona: "Rachel",
    trait: "Confident & Helpful",
    audioSrc: "/audio/realestate-en.mp3",
    fallbackLang: "en-US",
    fallbackDuration: 36,
  },
  {
    ...
    audioSrc: "/audio/realestate-hi.mp3",
    fallbackLang: "hi-IN",
    fallbackDuration: 40,
  },
  {
    ...
    audioSrc: "/audio/realestate-te.mp3",
    fallbackLang: "te-IN",
    fallbackDuration: 40,
  },
  {
    id: "healthcare-en",
    categoryId: "healthcare" as VoiceDemoCategoryId,
    language: "English",
    languageNative: "English",
    scriptBadge: "EN",
    persona: "Sophia",
    trait: "Calm & Reassuring",
    audioSrc: "/audio/healthcare-en.mp3",
    fallbackLang: "en-US",
    fallbackDuration: 36,
  },
  {
    ...
    audioSrc: "/audio/healthcare-hi.mp3",
    fallbackLang: "hi-IN",
    fallbackDuration: 40,
  },
  {
    ...
    persona: "Keerthi",
    trait: "Gentle & Clear",
    audioSrc: "/audio/healthcare-te.mp3",
    fallbackLang: "te-IN",
    fallbackDuration: 40,
  },
] as const;
